...
var _slotHeader = __webpack_require__(5);
...
exports.default = function (context) {
  return new Promise(function (resolve, reject) {
    ...
    var fileData = _fs2.default.readFileSync(process.cwd() + '/client/index/assets/cates.json', 'utf8');

    var headerNav = JSON.parse(fileData);
    var newRoters = [];
    if (headerNav.length > 0) {
      headerNav.map(function (item, index) {
        newRoters.push({
          path: '/' + item.defaultUrl + '___' + item._id,
          component: _slotHeader2.default,
          name: item.name,
...
var _vuexRouterSync = __webpack_require__(67);

var _elementUi = __webpack_require__(62);
...
function createApp() {
    ...
    var preFetchComponent = [_header2.default];
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        if (this.headerNav.length > 0) {
            this.headerNav.map(function (item, index) {
                newRoters.push({
                    path: '/' + item.defaultUrl + '___' + item._id,
                    component: _slotHeader2.default,
                    name: item.name,
...
var validatorUtil = __webpack_require__(25);
exports.default = {
  name: 'Login',
  data: function data() {
    return {
...
}, (0, _vuex.mapActions)(['getContentDetails']), {
    asyncData: function asyncData(_ref) {
        var store = _ref.store,
            route = _ref.route;
...
exports.default = {
    ...
    methods: _extends({}, (0, _vuex.mapActions)(['indexContentList']), {
...
// module
exports.push([module.i, ".view{text-align:center;padding-top:1rem}.fade-enter-active,.fade-leave-active{transition:all .2s ease}.fade-enter,.fade-leave-active{opacity:0}.content{display:inline-block;width:960px;min-height:100vh;background-color:#fff;padding:1rem}@media (max-width:768px){.content{width:100%;padding:.5rem;box-sizing:border-box}}", ""]);
...
// module
exports.push([module.i, ".header .header-main{margin:0 auto;padding:25px 0;overflow:hidden}.header .header-main .header-logo img{height:40px}.header .header-main .header-nav{height:40px;float:left;margin-top:10px;border-left:1px solid #f1eee0;margin-left:60px}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('header', {
    ...
    staticClass: "header-nave"
  }, [_c('ul', [_vm._v("\n                            " + _vm._s(_vm.headerNav) + "\n                            "), _vm._l((_vm.headerNav), function(nav) {
...
if(content.locals) module.exports = content.locals;
// add CSS to SSR context
__webpack_require__(2)("5d0072c0", content, true);
