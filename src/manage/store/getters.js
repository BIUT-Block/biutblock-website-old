export default {
    ...
    unionRegUserFormState: state => state.unionRegUser.formState,
    unionRegUserList: state => state.unionRegUser.userList,
    unoinShareUserList: state => state.unionShareDetailList.formState,
